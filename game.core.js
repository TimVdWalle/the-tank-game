...
game_core.prototype.client_ongamesoverview = function(data) {
        //The server responded with an overview of the games
    console.log("client ongamesoverview");
    var gameRoomCount = Object.keys(data.gameRooms).length;
    if(gameRoomCount){
        console.log("filling rooms");
        fillGameRoomDropDown(data.gameRooms);
    } else {
...
game_core.prototype.client_connect_to_server = function() {
        ...
        this.socket.on('onconnected', this.client_onconnected.bind(this));
            ...
            //send rooms to the client after connected
        this.socket.on('ongamesoverview', this.client_ongamesoverview.bind(this));
